AntXtras - WHAT IS IT?
======================
JWare/AntXtras Foundation (AntXtras) is a collection
of very useful add-on Ant components AND a powerful
Ant extension library. AntXtras extends Ant with a
set of new types, conditions, and tasks that make
it easy for you to use Ant to solve a great variety
of problems. Read more information on our website:
